...
namespace SynchubServer.Cosco
{
    public class CoscoRequester
    {
        ...
        private static string _host { get { return ServerConfig.Instance.APIHost; } }
        private static string _apiKey { get { return ServerConfig.Instance.APIKey; } }
        private static string _apiSecret { get { return ServerConfig.Instance.APISecret; } }
        ...
        public async Task<SynconHubResponse> Request(string urlPath, string body, string method = "POST", CancellationTokenSource cancellationTokenSource = null)
        {
            try
            {
                /*
