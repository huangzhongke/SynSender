...
namespace Jst.SynchubClient.Kmtc.entity
{
    public class KmtcFormVo
    {
        ...
        {
            string content = @$"任务Id: {this.Id} 出发地: {this.Departure.plcEnm}目的地: {this.Arrival.plcEnm}箱型: {this.Equipment}航名: {this.VesselName}航次: {this.Voyage}航期: {this.ShipDate}箱量：{this.Quantity}运行时间: {this.StartRunDate.Value.ToString()} - {this.EndRunDate.Value.ToString()}";
            return content;
        }
